...
function salePage() {
  shell(`<section class="page-hero"><p class="eyebrow">THE | WESHALKA</p><h1>Акции</h1><p>Специальные предложения и скидки на верхнюю одежду.</p></section>
<section class="section" style="text-align:center;padding:80px 7vw">
<p style="font-size:18px;color:var(--muted);max-width:500px;margin:0 auto">Следите за обновлениями — скоро здесь появятся актуальные акции и специальные предложения.</p>
